...
import { getEffectiveLanguage, getStoredLanguage } from './localizationUtil';
import { DEFAULT_NAMESPACE, FALLBACK_LANGUAGE, SupportedLang } from '@/constants/localizationConstants';

export type Namespace = string;

export const NAMESPACES: Namespace[] = ['common', 'pages'];
...
export const initI18n = async (initialLng: SupportedLang) => {
  ...
  const lang = getEffectiveLanguage(stored ?? initialLng);
