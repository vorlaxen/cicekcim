                ...
                <div className={cn("relative h-full")}>
                    ...
                    >
                        <span className={cn("relative z-10 flex items-center")}>
                            ...
                            <span className="ml-2">{tPages("status.404.button")}</span>
                        </span>
